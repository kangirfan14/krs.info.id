const DATABASE_BERITA = [
  ...
  },
  {
    ...
    kronologi: `
            ...
            <p> Mulai dari kain tenun yang unik, kerupuk khas Karangsari yang legendaris, hingga kerajinan tusuk sate, melalui semangat Desa Karangsari, 
             pencapaian ini menjadi titik awal transformasi desa dalam mengembangkan potensi pariwisata berbasis budaya dan kreativitas warga yang siap bersaing di kancah yang lebih luas.</p>
  ...
  },
  {
    ...
    kronologi: `
            ...
            diselenggarakan oleh DPPKBP3A Kabupaten Cirebon, penghargaan ini diberikan langsung di Taman Hutan Kota Sumber 
            pada 08 Agustus 2024 kepada Ardiansyah sebagai perwakilan tim.</p>
            <p> Keberhasilan mempertahankan gelar juara satu selama dua tahun berturut-turut ini membuahkan apresiasi berupa 
            trofi serta sertifikat resmi yang ditandatangani langsung oleh Pj Bupati Cirebon, pencapaian ini membuktikan bahwa 
            kreativitas sineas muda Karangsari terus berkembang dan diakui secara luas di tingkat daerah.</p>
  ...
  },
  {
    ...
    kronologi: `
            ...
            rencana ambisius pembangunan Bumi Perkemahan (Buper) di area belakang GOR Karangsari, serta pembangunan Alun-Alun Gentong
             yang direncanakan berlokasi di samping GOR, tepat di dekat kawasan Pasar Karangsari.</p>
            <p> Integrasi kedua proyek ini digadang-gadang akan menjadi motor penggerak ekonomi baru bagi warga lokal dan memperkuat posisi 
            Karangsari sebagai destinasi wisata unggulan di Kabupaten Cirebon. Namun, pantauan di lapangan menunjukkan kondisi yang jauh dari 
            rencana tersebut. Lahan yang semula diproyeksikan untuk area perkemahan hingga saat ini masih berupa hamparan sawah yang aktif 
            ditanami padi.</p>
            <p> Ketidakjelasan jadwal eksekusi pembangunan ini mulai menimbulkan pertanyaan di tengah masyarakat. Meskipun bukti rencana tersebut 
            telah terpublikasi secara luas melalui dokumentasi video desa, belum ada tanda-tanda pengerjaan fisik maupun sosialisasi lanjutan mengenai
             kapan proyek ini akan dimulai. Warga berharap agar wacana yang telah menjadi konsumsi publik tersebut segera menemui titik terang, 
             sehingga lahan tersebut dapat benar-benar memberikan manfaat nyata sesuai dengan visi Desa Wisata yang telah dicanangkan.</p>
  ...
  },
  {
    ...
    kronologi: `<p><strong>Jelawe</strong> — Semangat kemerdekaan terasa begitu kental di blok Jelawe. Rangkaian perayaan Hari Ulang Tahun HUT ke-81 Republik Indonesia yang diselenggarakan oleh Jelawe Bersatu
            sukses menarik perhatian seluruh warga dari berbagai kalangan usia.
            Acara diawali dengan kegiatan Jalan Sehat Warga yang memenuhi jalur rute yang telah di tentukan dengan penuh semangat pagi. Setelah itu, kemeriahan berlanjut dengan ajang Lomba Miniatur, di mana warga dari 
            berbagai wilayah menampilkan karya seni dan kreativitas terbaik mereka.
            Suasana semakin meriah ketika panitia membuka berbagai perlombaan khas tujuhbelasan yang diikuti dengan antusias oleh anak-anak hingga orang dewasa. Di sela-sela perlombaan, panitia juga membagikan doorprize 
            menarik yang membuat warga semakin bersemangat.
              Dari hasil penilaian dewan juri pada Lomba Miniatur, tercatat sebanyak enam pemenang yang berhasil membawa pulang piala. Penyerahan hadiah tersebut diserahkan langsung oleh tokoh-tokoh masyarakat setempat
              kepada para pemenang.</p><p>Acara yang paling ditunggu-tunggu oleh warga adalah pengundian kupon doorprize. Para pemilik kupon tampak sabar menunggu sambil mendengarkan pengumuman dari MC untuk memperebutkan berbagai hadiah 
                  menarik yang terpajang di atas panggung, termasuk hadiah utama berupa satu unit sepeda gunung.</p><p>Kesuksesan dan kekompakan seluruh warga dalam perayaan HUT RI ke-81 ini menjadi bukti nyata eratnya kebersamaan di blok Jelawe.</p>`,
  },
];
